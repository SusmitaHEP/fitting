...
void fitSignalBkg3(){
    ...
    ZJetsTree->Draw("PrunedMass1>>PrunedMassZBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    WJetsTree->Draw("PrunedMass1>>PrunedMassWBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    TTBarTTree->Draw("PrunedMass1>>PrunedMassTTBarBkg","(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    QCDTree->Draw("PrunedMass1>>PrunedMassQCDBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    T5HH1300Tree->Draw("PrunedMass1>>PrunedMassT5HH1300Sig", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    T5HH1700Tree->Draw("PrunedMass1>>PrunedMassT5HH1700Sig", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<200 && PrunedMass2>70 && PrunedMass2<100)*Evtweight*(80/35.9)");
    ...
    cout<<""<<PrunedMassTTBarBkg->Integral()<<endl;
    cout<<""<<PrunedMassWBkg->Integral()<<endl;
...
*/    
    ...
    hstack->Draw("hist"); 
    PrunedMassT5HH1700Sig->Draw("hist same"); PrunedMassT5HH1300Sig->Draw("hist same"); leg->Draw();
    c->SaveAs("histo.png");

    ZJetsTree->Draw("MET>>METZBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    WJetsTree->Draw("MET>>METWBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    TTBarTTree->Draw("MET>>METTTBarBkg","(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    QCDTree->Draw("MET>>METQCDBkg", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    T5HH1300Tree->Draw("MET>>METT5HH1300Sig", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    T5HH1700Tree->Draw("MET>>METT5HH1700Sig", "(MET>300 && HT>1000 && JetPt1>600 && JetPt2>400 && PrunedMass1>50 && PrunedMass1<70 && PrunedMass2>50 && PrunedMass2<200)*Evtweight*(80/35.9)");
    ...
    METBins->setRange("METBin2", 500, 800);
    METBins->setRange("METBin3", 800, 1200);
    METBins->setRange("METBin4", 1200, 1500);
...
new TCanvas("rf208_convolution2","rf208_convolution2",600,600) ;
    ...
    frame->Draw("hist same"); PrunedMassT5HH1300Sig->Draw("hist same"); leg->Draw();
    ...
    // Draw frame on canvas
     ...
     std::cout<<"MET Bin Fractions "<<METBin1SRB->getVal()<<", "<<METBin2SRB->getVal()<<", "<<METBin3SRB->getVal()<<", "<<METBin4SRB->getVal()<<std::endl;
     std::cout<<"MET Bin Bkg Predictions "<<METBin1SRB->getVal()*BkginSR->getVal()*TotalBkg->Integral() <<", "<<METBin2SRB->getVal()*BkginSR->getVal()*TotalBkg->Integral() <<", "<<METBin3SRB->getVal()*BkginSR->getVal()*TotalBkg->Integral() <<", "<<METBin4SRB->getVal()*BkginSR->getVal()*TotalBkg->Integral()<<std::endl;
...
new TCanvas("rf208_convolution","rf208_convolution",600,600) ;
    ...
    frame2->Draw("hist same"); METT5HH1300Sig->Draw("hist same"); leg->Draw();
