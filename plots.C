...
void plots(){
    ...
    ZJetsTree->Draw("PrunedMass1>>PrunedMassZBkg", "(MET>300)*Evtweight*(80/35.9)");
    WJetsTree->Draw("PrunedMass1>>PrunedMassWBkg", "(MET>300)*Evtweight*(80/35.9)");
    TTBarTTree->Draw("PrunedMass1>>PrunedMassTTBarBkg","(MET>300)*Evtweight*(80/35.9)");
    QCDTree->Draw("PrunedMass1>>PrunedMassQCDBkg", "(MET>300)*Evtweight*(80/35.9)");
    T5HH1300Tree->Draw("PrunedMass1>>PrunedMassT5HH1300Sig", "(MET>300)*Evtweight*(80/35.9)");
    T5HH1700Tree->Draw("PrunedMass1>>PrunedMassT5HH1700Sig", "(MET>300)*Evtweight*(80/35.9)");
